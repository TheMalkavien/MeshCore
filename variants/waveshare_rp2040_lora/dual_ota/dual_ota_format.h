...
// The installer manifest occupies the 64 bytes immediately before the four
// Arduino-Pico partition words. Both are part of the immutable 12 KiB shim
// prefix covered by the serial bootloader header.
